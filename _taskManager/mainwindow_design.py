...
class Ui_LRCSNet(object):
    def setupUi(self, LRCSNet):
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap("rubik.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.predict_button.setIcon(icon6)
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap("002-speedometer.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.dashboard_button.setIcon(icon7)

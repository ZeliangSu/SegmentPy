...
class Ui_volViewer(object):
    def setupUi(self, volViewer):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("_taskManager/zoom-in.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("_taskManager/zoom-out.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.accum_plot1.setMinimumSize(QtCore.QSize(0, 300))
        self.accum_plot1.setObjectName("accum_plot1")
        self.horizontalLayout_3.addWidget(self.accum_plot1)
        ...
        self.accumulated_value1.setMinimumSize(QtCore.QSize(100, 300))
        font = QtGui.QFont()
        ...
        self.horizontalLayout_3.addWidget(self.accumulated_value1)
        ...
        self.accumulated_value2.setMinimumSize(QtCore.QSize(100, 300))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        self.accumulated_value2.setFont(font)
        self.accumulated_value2.setObjectName("accumulated_value2")
        self.horizontalLayout_3.addWidget(self.accumulated_value2)
        ...
        self.accum_plot2.setMinimumSize(QtCore.QSize(0, 300))
        self.accum_plot2.setObjectName("accum_plot2")
        self.horizontalLayout_3.addWidget(self.accum_plot2)
